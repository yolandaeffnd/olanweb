@extends('backend.app') @section('js')
        ...
        <form method="POST" action="{{ route('registrasi.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <div class="form-check">
                        <label class="form-check-label"> <input type="radio" class="form-check-input" name="tipe" id="tipe1" value="Baru" }} /> Baru <i class="input-helper"></i></label>
                    </div>
                </div>
                <div class="col-sm-5">
                    <div class="form-check">
                        <label class="form-check-label"> <input type="radio" class="form-check-input" name="tipe" id="tipe2" value="Lama" /> Lama <i class="input-helper"></i></label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="id_periode" class="form-control">
                    ...
                    <?php $periode2 = \App\Periode2::where('status','aktif')->get(); ?> @foreach($periode2 as $data)
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <div class="form-check">
                        <label class="form-check-label"> <input type="radio" class="form-check-input" name="status_pembayaran" id="status_pembayaran" value="bayar" checked="" }} /> Bayar <i class="input-helper"></i></label>
                    </div>
                </div>
                <div class="col-sm-5">
                    <div class="form-check">
                        <label class="form-check-label"> <input type="radio" class="form-check-input" name="status_pembayaran" id="status_pembayaran" value="belum_bayar" /> Belum Bayar <i class="input-helper"></i></label>
                    </div>
                </div>
            </div>
            <div class="form-group">
          ...
          <label for="exampleInputEmail1">Jenis Kelamin</label>
            <input name="jk" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="jenis kelamin">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-check">
                            <label class="form-check-label"> <input type="radio" class="form-check-input" name="jk" id="jk" value="Laki-laki" checked="" /> Laki-laki <i class="input-helper"></i></label>
                        </div>
                    </div>
                    <div class="col-sm-5">
                        <div class="form-check">
                            <label class="form-check-label"> <input type="radio" class="form-check-input" name="jk" id="jk" value="Perempuan" /> Perempuan <i class="input-helper"></i></label>
                        </div>
                    </div>
                </div>
